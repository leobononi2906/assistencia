...
const MENU=[
  ...
  {grupo:'Relatórios',itens:[
    ...
    {id:'rel_compras',label:'Compras',mod:'RELATORIOS'},
    {id:'rel_produtos',label:'Produtos',mod:'RELATORIOS'},
    {id:'rel_clientes',label:'Clientes',mod:'RELATORIOS'},
    {id:'dre',label:'DRE',mod:'RELATORIOS'},
...
const SCREENS={
  ...
  rel_compras:{title:'Relatório de Compras',load:()=>loadRelCompras()},
  rel_produtos:{title:'Relatório de Produtos',load:()=>loadRelProdutos()},
  rel_clientes:{title:'Relatório de Clientes',load:()=>loadRelClientes()},
  dre:{title:'DRE — Demonstração do Resultado',load:()=>loadDRE()},
